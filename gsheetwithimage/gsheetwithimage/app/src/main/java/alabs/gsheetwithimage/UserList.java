...
import alabs.gsheetwithimage.R;
...
public class UserList extends AppCompatActivity  {
    ...
    private void showJSON(String json){
        ...
        pj.parseJSON();
        Log.e("Gambar","ser image"+JsonParser.Gambars[1]);
        UserListAdapter userListAdapter = new UserListAdapter(this, JsonParser.NomorSpesifiks,JsonParser.JenisAsetTetaps,JsonParser.Gambars);
